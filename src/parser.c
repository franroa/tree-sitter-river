...
enum ts_symbol_identifiers {
  ...
  sym_numeric_variable_reference = 38,
  ...
  sym_function_params = 60,
  sym_numeric_lit = 61,
  sym_bool_lit = 62,
  sym_string_lit = 63,
  sym_interpolation = 64,
  sym_interpolated_expression = 65,
  aux_sym_config_file_repeat1 = 66,
  aux_sym_block_body_repeat1 = 67,
  aux_sym_qualified_identifier_repeat1 = 68,
  aux_sym__array_elems_repeat1 = 69,
  aux_sym_object_repeat1 = 70,
  aux_sym_string_lit_repeat1 = 71,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_part_character_set_1, 677, lookahead)) ADVANCE(48);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '!', 12,
    ...
    case 34:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') ADVANCE(95);
      if (set_contains(sym_object_identifier_character_set_1, 793, lookahead)) ADVANCE(36);
      END_STATE();
    case 35:
      ACCEPT_TOKEN(sym_object_identifier);
      if (lookahead == '"') ADVANCE(31);
    ...
    case 38:
      ...
      if (set_contains(sym_object_identifier_character_set_1, 793, lookahead)) ADVANCE(48);
      END_STATE();
    case 39:
      ACCEPT_TOKEN(sym_identifier_part);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    [sym_config_file] = STATE(170),
    [sym_block] = STATE(150),
    [sym_qualified_identifier] = STATE(152),
    [aux_sym_config_file_repeat1] = STATE(150),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qualified_identifier, 1, 0, 1),
  [87] = {.entry = {.count = 1, .reusable = true}}, SHIFT(174),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_qualified_identifier, 1, 0, 1),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qualified_identifier, 2, 0, 2),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_qualified_identifier, 2, 0, 2),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 5),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 5), SHIFT_REPEAT(174),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 5), SHIFT_REPEAT(167),
  ...
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_lit, 3, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_lit, 3, 0, 0),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 3, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 3, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression, 3, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expression, 3, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 3, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3, 0, 8),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 3, 0, 8),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_operation, 3, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [153] = {.entry = {.count = 1, .reusable = false}}, SHIFT(14),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_operation, 3, 0, 0),
  ...
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4, 0, 10),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 4, 0, 10),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_access, 4, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_access, 4, 0, 0),
  [175] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_qualified_identifier_repeat1, 2, 0, 5), SHIFT_REPEAT(171),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_lit, 1, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_lit, 1, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool_lit, 1, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool_lit, 1, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_value, 1, 0, 0),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal_value, 1, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operation, 1, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_operation, 1, 0, 0),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 2, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 2, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_operation, 2, 0, 0),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 2, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_operation, 2, 0, 0),
  ...
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object_assignment, 3, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object_assignment, 3, 0, 0),
  [224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_params, 1, 0, 0),
  ...
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__array_elems, 1, 0, 0),
  [238] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__array_elems_repeat1, 2, 0, 0),
  ...
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolated_expression, 1, 0, 0),
  ...
  [294] = {.entry = {.count = 1, .reusable = false}}, SHIFT(136),
  ...
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_lit_repeat1, 2, 0, 0),
  [306] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_lit_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  [309] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_lit_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [312] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_lit_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  ...
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_body_repeat1, 2, 0, 0),
  [325] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_body_repeat1, 2, 0, 0), SHIFT_REPEAT(149),
  [328] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2, 0, 0), SHIFT_REPEAT(131),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2, 0, 0),
  [333] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_object_repeat1, 2, 0, 0), SHIFT_REPEAT(168),
  ...
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3, 0, 9),
  [346] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3, 0, 9),
  ...
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_key, 1, 0, 0),
  [356] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_config_file, 1, 0, 0),
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_config_file_repeat1, 2, 0, 0),
  [360] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_config_file_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [363] = {.entry = {.count = 1, .reusable = true}}, SHIFT(163),
  [365] = {.entry = {.count = 1, .reusable = true}}, SHIFT(138),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 1, 0, 0),
  [369] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_object_repeat1, 1, 0, 0),
  [371] = {.entry = {.count = 1, .reusable = true}}, SHIFT(159),
  [373] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__array_elems_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [376] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 3),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 6),
  [382] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_params, 2, 0, 0),
  [384] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_object_repeat1, 2, 0, 0),
  [386] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_body, 2, 0, 0),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_body, 3, 0, 0),
  ...
  [406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3, 0, 0),
